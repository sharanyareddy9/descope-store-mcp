...
function s(e) {
  ...
  if (e.content.type === "rawHtml") {
    ...
    if (t = e.content.iframeUrl, typeof t != "string")
      throw new Error(
...
export {
  ...
  d as ReservedUrlParams,
  s as createUIResource,
  l as postUIActionResult,
  y as uiActionResultIntent,
  E as uiActionResultLink,
  h as uiActionResultNotification,
  w as uiActionResultPrompt,
  m as uiActionResultToolCall
};
