 ...
 */
export function createAuthenticatedDescopeClient(config, userToken) {
 ...
 */
export function extractUserIdFromAuthInfo(authInfo) {
    try {
 ...
 * ```
 */
export async function getOutboundToken(appId, authInfo, config, scopes) {
    var _a, _b;
 ...
 */
export function createOutboundTokenFactory(config) {
