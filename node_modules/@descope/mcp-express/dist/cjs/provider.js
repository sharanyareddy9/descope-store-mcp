...
exports.DescopeMcpProvider = exports.readEnv = void 0;
...
class DescopeMcpProvider {
    constructor({ projectId = (0, exports.readEnv)("DESCOPE_PROJECT_ID"), managementKey = (0, exports.readEnv)("DESCOPE_MANAGEMENT_KEY"), baseUrl = (0, exports.readEnv)("DESCOPE_BASE_URL"), serverUrl = (0, exports.readEnv)("SERVER_URL"), ...opts } = {}) {
        var _a, _b;
        ...
        this.descope = (0, node_sdk_1.default)({
...
exports.DescopeMcpProvider = DescopeMcpProvider;
