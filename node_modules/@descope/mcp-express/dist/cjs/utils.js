...
exports.registerAuthenticatedTool = registerAuthenticatedTool;
exports.defineTool = defineTool;
const outboundToken_js_1 = require("./utils/outboundToken.js");
const requestContext_js_1 = require("./utils/requestContext.js");
/**
 * Validates scopes against the authenticated user's scopes
 */
function validateScopes(authInfo, requiredScopes = []) {
...
cb, requiredScopes = []) {
    return (server) => {
        ...
        const wrapped = async (args, extra) => {
            ...
            const context = (0, requestContext_js_1.getRequestContext)(server);
            ...
            const getOutboundTokenFn = (appId, scopes) => descopeConfig
                ? (0, outboundToken_js_1.getOutboundToken)(appId, authInfo, descopeConfig, scopes)
